...
A list of currently available or upcoming contract opportunities, prioritized by relevance to my background.
...
Summarize how well each opportunity matches my professional qualifications.
Provide recommendations on how to tailor my application or capability statement to align with the opportunity.
If needed, suggest keywords, search terms, or filters I can use to independently search for similar opportunities in the future.
